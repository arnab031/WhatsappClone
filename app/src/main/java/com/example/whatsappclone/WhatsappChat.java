...
public class WhatsappChat extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtMessage = findViewById(R.id.edtSend);
    ...
    public void onClick(View v) {
        ...
        chat.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if(e==null){
                    FancyToast.makeText(WhatsappChat.this,"Message from "+ParseUser.getCurrentUser().getUsername()+ " sent to "+selectedUser, Toast.LENGTH_SHORT,FancyToast.INFO,true).show();
